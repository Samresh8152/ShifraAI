  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
    ...
    >
      ...
      <h1 className="text-2xl font-bold text-gray-800 leading-none" >
        Shifra{" "}<span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500' >AI</span>
      </h1> 
    </div>
...
<button onClick={() => navigate("/billing")} className="ml-2 px-4 py-2 rounded-xl border border-orange-100 bg-white text-gray-700 text-sm font-medium hover:border-purple-300 transition-all cursor-pointer  " >
  Billing
</button>
